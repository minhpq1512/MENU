        ...
        <ul>
            ...
            <li>
                ...
                <ul class="submenu" id="submenu2">
                    ...
                    <li><a href="?page=ngay_nghi">Danh mục ngày nghỉ</a></li>
                </ul>
            </li>
            <li>
    ...
    <div class="content">
        ...
        switch ($page) {
            ...
            case 'danh_muc_xe':
                ...
                break;
            case 'nhan_vien':
                echo "<h3>Danh mục nhân viên</h3><p>Nội dung quản lý nhân viên...</p>";
                break;
            case 'phan_cong':
                echo "<h3>Lịch phân công</h3><p>Nội dung lịch phân công...</p>";
                break;
            case 'ngay_nghi':
                echo "<h3>Danh mục ngày nghỉ</h3><p>Nội dung ngày nghỉ...</p>";
                break;
            case 'tuyen_duong':
                echo "<h3>Danh mục tuyến đường</h3><p>Nội dung tuyến đường...</p>";
                break;
            case 'hanh_khach':
                echo "<h3>Danh mục hành khách</h3><p>Nội dung hành khách...</p>";
                break;
            case 'bang_gia':
                echo "<h3>Bảng giá</h3><p>Nội dung bảng giá...</p>";
                break;
            case 'chuyen_xe':
                echo "<h3>Quản lý chuyến xe</h3><p>Nội dung quản lý chuyến xe...</p>";
                break;
            case 'ban_ve':
